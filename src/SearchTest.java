...
public class SearchTest {
    public static void main(String[] args) {
        ...
        System.out.println(Search.linearSearchBol(numArray, 38));
        System.out.println(Search.linearSearchBol(numArray, 9));
        System.out.println(Search.linearSearchBol(numArray, 5));
